...
@section('content')
    ...
    <div class="mt-8">
        <form action="{{ route('admin.productCategory.create') }}" method="POST">
            @csrf
            <div class="">
                <label class="text-xl font-bold" for="">Mã danh mục</label> <br>
            ...
            <div class="mt-6">
                ...
                <textarea rows="5px" cols="150px" class="outline-none border-indigo-300 border mt-4 pl-4 pt-4" name="description"></textarea>
            </div>
            <div class="mt-6">
