    ...
    <div class="mt-8">
        <form action="{{ route('admin.productCategory.edit', ['id' => $productCategory->product_category_id]) }}" method="POST">
            ...
            <div class="">
                ...
                <input class="w-full py-3 outline-none pl-5 border-collapse border-indigo-300 border mt-4" type="text" name="product_category_name" value="{{ $productCategory->product_category_name }}">
            </div>
            <div class="mt-6">
            ...
            <div class="mt-6">
                ...
                <textarea rows="5px" cols="150px" class="outline-none border-indigo-300 border mt-4 pl-4 pt-4" name="description">
            ...
            <div class="mt-6">
                ...
                <div class="mt-4">
                    <input type="radio" name="status" id="active" value="active" @checked($productCategory->status == "active")>
                    <label class="text-xl mr-6" for="status">Hoạt động</label>
                    <input type="radio" name="status" id="inactive" value="inactive" @checked($productCategory->status == "inactive")>
