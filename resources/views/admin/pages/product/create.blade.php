...
<div class="mt-8">
    <form action="{{ route('admin.product.create') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex justify-between">
            <div class="mr-8">
                <div class="">
                    ...
                    <input class="w-full py-3 outline-none pl-5 rounded-xl border-collapse border-indigo-300 border mt-4" type="text" name="product_name">
                </div>
                ...
                <div class="mt-6 w-3/4">
                    ...
                    <textarea id="myeditorinstance" rows="12px" cols="90px" class="rounded-sm outline-none border-indigo-300 border mt-4 pl-4 pt-4" name="description"></textarea>
                </div>
            ...
            <div class="flex-1">
                <div class="">
                    ...
                    <input class="w-full py-3 outline-none pl-5 rounded-xl border-collapse border-indigo-300 border mt-4" step="0.01" type="number" name="price">
                </div>
                <div class="mt-6">
                    <label class="text-xl font-bold" for="quantity">Số lượng</label> <br>
                    <input class="w-full py-3 outline-none pl-5 rounded-xl border-collapse border-indigo-300 border mt-4" type="number" name="quantity">
                </div>
                <div class="mt-6">
                    <label class="text-xl font-bold" for="discount">Giảm giá %</label> <br>
                    <input class="w-full py-3 outline-none pl-5 rounded-xl border-collapse border-indigo-300 border mt-4" type="number" name="discount" value="0" min='0'>
                </div>
                <div class="mt-6">
        ...
        <div class="mt-6">
            <button class="px-4 py-3 w-full bg-blue-600 rounded-xl text-white text-xl font-bold italic hover:bg-slate-500" type="submit">THÊM</button>
        </div>
    </form>
</div>
