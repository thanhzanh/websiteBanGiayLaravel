...
<div class="flex justify-between">
    ...
    <div class="mt-[20px] items-center align-middle">
        ...
        <a href="" title="Thêm" class="p-4 bg-blue-700 text-[1rem] font-bold text-white rounded-2xl ml-16 hover:bg-black"><i class="fa-solid fa-plus"></i></a>
    </div>
</div>
    ...
    <table class="w-full shadow-2xl uppercase border-2 border-cyan-200 ">
        ...
        <tbody class="bg-cyan-400">
            <tr class="text-center text-black border-b-2 duration-300">
                <td>1</td>
                <td>Giày nike air force one</td>
                <td class="items-center align-middle pt-2 pb-2 ">
                    <img style="width:160px;" class="items-center h-[140px] m-auto flex justify-items-center" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAX6UA30boiYpVCSfJeGT4ry7EeTYdNPEi1Q&s" alt="">
                </td>
                <td>
                    <input type="number" name="quantity" min="1" value="12" class="text-center text-xl w-[70px]">
                </td>
                <td>1.000.000đ</td>
                <td>Hoạt động</td>
                <td>10/11/2024</td>
